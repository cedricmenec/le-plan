...
- [x] Task: Create mission detail page route at `app/missions/[id]/page.tsx` with basic mission data fetching. (a7b1c2d)
- [ ] Task: Implement two-column layout (Mission Info Left, Subtasks Right) and mobile responsiveness.
