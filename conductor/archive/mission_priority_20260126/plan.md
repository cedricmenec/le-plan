...
- [x] Task: Implement In-line Editing on Mission Detail Page
    - [x] Add `PriorityBadge` with `InlineEditableField` support in `app/missions/[id]/page.tsx`
    - [x] Ensure the update action is correctly wired
    - [x] Add/Update tests for `app/missions/[id]/page.test.tsx`
- [x] Task: Update Project Detail Page List
    - [x] Display `PriorityBadge` in the "Missions non commencées" list in `app/projects/[id]/page.tsx`
    - [x] Update tests in `app/projects/[id]/page.test.tsx`
- [x] Task: Conductor - User Manual Verification 'Phase 4: View Integration & In-line Editing' (Protocol in workflow.md)
