...
- [x] Task: Manual Verification.
    - [x] Verify that clicking the icon opens the dropdown.
    - [x] Verify that the dropdown items look correct (Icon + Text).
    - [x] Verify that selecting an item updates the task status and the trigger icon.
- [x] Task: Run existing tests to ensure no regressions in task management.
