# project-mission-queue Specification

## Purpose
Décrire la file d'attente ordonnée des missions `Queued`, par scope projet et le scope autonome : entrée/sortie de file, réordonnancement manuel, stabilité de l'ordre, normalisation des données et absence d'activation automatique.
